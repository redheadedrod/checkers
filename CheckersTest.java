...
public class CheckersTest {
    ...
    @Test
	public final void testCanMoveMethod2() {
    ...
    @Test
	public final void testCanMoveMethodNull() {
    ...
    @Test
	public final void testCanMoveMethod3() {
    ...
    @Test
	public final void testCanMoveMethod4() {
    ...
    @Test
	public final void testCanMoveMethod5() {
    ...
    @Test
	public final void testCanMoveMethod6() {
    ...
    @Test
	public final void testCanMoveMethod7() {
    ...
    @Test
	public final void testCanMoveMethod8() {
    ...
    @Test
	public final void testIsWinner1() {
    ...
    @Test
	public final void testIsWinner2() {
    ...
    @Test
	public final void testSetAndGetPlayer() {
    ...
    @Test
	public final void testIsWinner3() {
        for (int row = 0; row < 3; row++) {
            for (int col = 0; col < 8; col++) {
                if (row == 2 && col == 7) {
                    continue;
    ...
    @Test
	public final void testIsWinner4() {
        this.model.setCurrentPlayer();
        for (int row = 7; row > 4; row--) {
            for (int col = 0; col < 8; col++) {
                if (row == 5 && col == 6) {
    ...
    @Test
	public final void testIsWinner5() {
        assertFalse(this.model.isWinner());
    }

    @Test
	public final void testIsWinner6() {
        this.model.setCurrentPlayer();
        assertFalse(this.model.isWinner());
    }

    @Test
	public final void testIsWinner7() {
        for (int row = 0; row < 3; row++) {
            for (int col = 0; col < 8; col++) {
    ...
    @Test
	public final void testIsWinner8() {
        this.model.setCurrentPlayer();
        for (int row = 7; row > 4; row--) {
            for (int col = 0; col < 8; col++) {
